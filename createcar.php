...
echo " DATEBASE  Connected ";
  ...
  if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    do{
        ...
        if(empty($idcar)||empty($id)||empty($carnum)||empty($carname)||empty($carcoler)||empty($mileage)||empty($insn)||empty($inst)||empty($datebins)||empty($datefins)){
...
<body>
    ...
    <div class="row mb-3">
        ...
        <div class="row mb-3">
            <label class="col-sm-3 col-form-label">Id Costumer</label>
            <div class="col-sm-6">
