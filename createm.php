...
if ($birthday->format("m-d") >= $today->format("m-d")) {
 echo 'The date is wrong';
        ...
        $sql= "INSERT INTO mecan (id, fullname, passw, firstname, familyname, birth, eemail, ephone, ecity, ereg, estr, codep, ssn, icn, license, ccp, holiday)".
  ...
  $successMessage="Mecanicien added correctly";
